...
public class RMIServer {
    public static void main(String[] args) throws Exception {
        ...
        context.bind("rmi://" + ipAddress + ":8081/baiThiService", baiThiService);

        CauHoiDAO cauHoiDAO = new CauHoiDAO(CauHoi.class);
        CauHoiService cauHoiService = new CauHoiServiceImpl(cauHoiDAO);
        context.bind("rmi://" + ipAddress + ":8081/cauHoiService", cauHoiService);
        ...
        context.bind("rmi://" + ipAddress + ":8081/cauTraLoiService", cauTraLoiService);

        ChuDeDAO chuDeDAO = new ChuDeDAO(ChuDe.class);
        ChuDeService chuDeService = new ChuDeServiceImpl(chuDeDAO);
        context.bind("rmi://" + ipAddress + ":8081/chuDeService", chuDeService);
        ...
        context.bind("rmi://" + ipAddress + ":8081/phienLamBaiService", phienLamBaiService);
        ...
        context.bind("rmi://" + ipAddress + ":8081/taiKhoanService", taiKhoanService);
