...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panelTTTK.setLayout(new GridLayoutManager(8, 3, new Insets(10, 10, 10, 10), 2, 2));
        panelTTTK.setBackground(new Color(-12387639));
        ...
        panelTTTK.add(lưuButton, new GridConstraints(7, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        lbLop = new JLabel();
        lbLop.setText("Lớp");
        panelTTTK.add(lbLop, new GridConstraints(6, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        txtLop.setText("10A2");
        panelTTTK.add(txtLop, new GridConstraints(6, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JLabel label6 = new JLabel();
        label6.setText("Ngày sinh");
        panelTTTK.add(label6, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JTextField textField1 = new JTextField();
        textField1.setDisabledTextColor(new Color(-16777216));
        textField1.setEditable(false);
        textField1.setEnabled(false);
        textField1.setSelectionColor(new Color(-16777216));
        textField1.setText("1/1/2000");
        panelTTTK.add(textField1, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        panelDMK = new JPanel();
        ...
        label7.setText("Đổi mật khẩu");
        panelDMK.add(label7, BorderLayout.NORTH);
    }
...
//        frame.setContentPane(new GiaoDienCaiDatTaiKhoan().$$$getRootComponent$$$());
